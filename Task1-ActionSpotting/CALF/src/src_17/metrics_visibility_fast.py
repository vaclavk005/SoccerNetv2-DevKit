...
def average_mAP(targets, detections, closests, model_name, framerate=2):
    ...
    save_mAP(mAP, mAP_per_class, mAP_visible, mAP_per_class_visible, mAP_unshown, mAP_per_class_unshown, model_name)
