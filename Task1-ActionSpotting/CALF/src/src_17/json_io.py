...
def save_mAP(mAP, mAP_per_class, mAP_visible, mAP_per_class_visible, mAP_unshown, mAP_per_class_unshown, model_name):
    json_path = os.path.join("models", model_name, "mAP.json")
    ...
    mAP_dict["mAP"] = mAP
    mAP_dict["mAP_visible"] = mAP_visible
    mAP_dict["mAP_unshown"] = mAP_unshown
